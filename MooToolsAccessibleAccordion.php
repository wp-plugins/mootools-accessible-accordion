...
function MooToolsAccessibleAccordion_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_MooToolsAccessibleAccordion') ) {
        ...
        // add your own script
        wp_register_script('mootools-core', ( get_bloginfo('wpurl') . '/wp-content/plugins/MooToolsAccessibleAccordion/lib/mootools-core.js'));
        wp_enqueue_script('mootools-core');

        wp_register_script('mootools-more-accordion', ( get_bloginfo('wpurl') . '/wp-content/plugins/MooToolsAccessibleAccordion/lib/mootools-more-accordion.js'));
        wp_enqueue_script('mootools-more-accordion');

        wp_register_script('MooToolsAccessibleAccordion', ( get_bloginfo('wpurl') . '/wp-content/plugins/MooToolsAccessibleAccordion/lib/MooToolsAccessibleAccordion.js'));
        wp_enqueue_script('MooToolsAccessibleAccordion');

        wp_register_style('MooToolsAccessibleAccordion_css', ( get_bloginfo('wpurl') . '/wp-content/plugins/MooToolsAccessibleAccordion/lib/MooToolsAccessibleAccordion.css'));
